...
_SYSTEM = (
    ...
    "1. 候选观察用【】标注了类别：【子力】丢子/得子、【战术】叉子/牵制/闪击(闪将)/串击等双重攻击、"
    "【杀棋威胁】这步让对方获得强制杀（你的王会被将死）——这是最高优先级，只要出现就几乎一定是核心，"
    "要讲清是王的安全而非子力、并提示必须先解杀、"
    "【对手回应】错着之后对手怎么惩罚、【王的安全】王被攻击、【强制】将军或强制杀、"
    "【牵制】你的某子被对方长子钉在更值钱的子（或王）前，动不了、通常因此受制或丢子、"
    "【线路】这步打开了某条竖线/横线/斜线，正好落在你自己的王或后上（对方车/象/后借线压制或牵制）——"
    "这往往比『丢一个兵』更关键，要讲清是线路而非那个兵、子的问题、"
    "【位置】没有丢子、但走坏了结构（坏象/弱格/王翼漏风/兵形弱点/子力变被动，"
    "也包括放任对手形成通路兵、留下永久弱格、让对方的子扎下前哨，或残局里的逼移zugzwang）、"
...
_JUDGE_SYSTEM = (
    ...
    "最高优先：若候选观察里出现【杀棋威胁】，它几乎一定就是核心原因——primary 要讲王被将死/必须解杀，"
    "use_facts 以【杀棋威胁】为主，不要被『丢一个兵』之类的子力观察带偏。\n"
